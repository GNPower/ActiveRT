...
ACTIVERT_EVENT_POOL_DEFINE(
    stats_pool_1, stats_test_event_t, STATS_POOL_SIZE, ACTIVERT_POOL_OVERFLOW_DROP
);
ACTIVERT_EVENT_POOL_DEFINE(
    stats_pool_2, stats_test_event_t, STATS_POOL_SIZE, ACTIVERT_POOL_OVERFLOW_DROP
);
...
ACTIVERT_ACTIVE_DEFINE_SIMPLE(
    stats_ao, stats_dispatch, STATS_AO_PRIO, STATS_AO_STACK, STATS_AO_QUEUE
);

/*******************************************************************************
 * FreeRTOSConfig.h — Configuration for the FreeRTOS POSIX/Linux simulator
 *
 * This file configures the FreeRTOS kernel for host-side testing via the
 * GCC_POSIX port. Tasks are simulated as Linux pthreads.
 *
 * Used only in the test/ build. Embedded targets use their own BSP config.
 ******************************************************************************/

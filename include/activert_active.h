 ...
 * @param queue_storages Array of pointers to queue storage buffers
 *                      Each buffer: activert_event_t*[queue_length]
 ...
 * @param queue_storages        Array of pointers to queue storage buffers (NULL if notify-only)

...
/** Pointer to a caller-provided event pointer array (storage for one queue). */
typedef activert_event_t** activert_queue_storage_t;
 ...
 */
typedef void (*activert_dispatch_handler_t)(activert_active_t* me, const activert_event_t* e);

/**
 * Active Object notification handler
 */
typedef void (*activert_notify_handler_t)(activert_active_t* me, uint32_t bits);
